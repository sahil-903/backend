...
const getAllVideos = asyncHandler(async (req, res) => {
    ...
    Video.aggregatePaginate(videoAggregate, options)
        .then(result => {
            ...
            throw new ApiError(500, error?.message || "Internal server error in video aggregate Pagination")
...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    const thumbnailLocalPath = req.files?.thumbnail[0]?.videoLocalPath
    ...
    .json(new ApiResponse(200, videoPublished, "Video Published Succeddfully"))
})
...
const getVideoById = asyncHandler(async (req, res) => {
    ...
    return res.status(200)
    .json(new application(200, video, "Video fetched succssfully"));
})
